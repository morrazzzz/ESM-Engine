...
ODE_API dJointID dJointCreateContactSpecial (dWorldID, dJointGroupID, const dContact *);
/**
...
ODE_API void dJointSetFixedQuaternionPos(dJointID J, dQuaternion quaternion, dReal* pos);
/*
