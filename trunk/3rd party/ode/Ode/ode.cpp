...
dxAutoDisable dxWorld::adis = { REAL(0.001) * REAL(0.001), REAL(0.001) * REAL(0.001), 10, 0, 1 };
...
dxDampingParameters dxWorld::dampingp = { 0, 0, REAL(0.01) * REAL(0.01), REAL(0.01) * REAL(0.01) };
dReal dxWorld::max_angular_speed = dInfinity;
