...
{
	ai().alife().add_restriction(object().ID(), id, restrictor_type);
}
...
{
	ai().alife().remove_restriction(object().ID(), id, restrictor_type);
}
...
{
	ai().alife().remove_all_restrictions(object().ID(), restrictor_type);
}
