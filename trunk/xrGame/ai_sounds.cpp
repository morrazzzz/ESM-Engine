...
xr_token anomaly_type_token[]={
	...
	{ "Weapon shooting",		static_cast<int>(SOUND_TYPE_WEAPON_SHOOTING) },
	{ "Weapon empty clicking",	static_cast<int>(SOUND_TYPE_WEAPON_EMPTY_CLICKING) },
	{ "Weapon bullet hit",		static_cast<int>(SOUND_TYPE_WEAPON_BULLET_HIT) },
	{ "Weapon recharging",		static_cast<int>(SOUND_TYPE_WEAPON_RECHARGING) },
