...
extern "C" IPHWorld *		__stdcall	physics_world();
class CObjectSpace;
class CObjectList;
class CRenderDeviceBase;
extern "C" void			__stdcall	create_physics_world(bool mt, CObjectSpace * os, CObjectList * lo, CRenderDeviceBase * dv);
extern "C" void			__stdcall	destroy_physics_world();
class CGameMtlLibrary;
extern "C" void			__stdcall	set_mtl_lib(CGameMtlLibrary * l);
//extern "C" CObjectSpace*	__stdcall	create_object_space();
struct hdrCFORM;
//extern "C" CObjectSpace*	__stdcall	mesh_create_object_space(Fvector* verts, CDB::TRI* tris, const hdrCFORM &H, CDB::build_callback build_callback);
extern "C" void			__stdcall	destroy_object_space(CObjectSpace* &os);