...
typedef class_exporter<dxRender_Visual>	dxRender_VisualScript;
add_to_type_list(dxRender_VisualScript)
#undef script_type_list
#define script_type_list save_type_list(dxRender_VisualScript)
/*
