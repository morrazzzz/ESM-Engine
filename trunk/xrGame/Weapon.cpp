...
const char* wpn_scope_def_bone = "wpn_scope";
const char* wpn_silencer_def_bone = "wpn_silencer";
const char* wpn_launcher_def_bone_shoc = "wpn_launcher";
const char* wpn_launcher_def_bone_cop = "wpn_grenade_launcher";
