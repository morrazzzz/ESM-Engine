...
{
	ec().assign_callback(SDL_SCANCODE_ESCAPE, Callback(this, &CUICustomEdit::press_escape));
	ec().assign_callback(SDL_SCANCODE_RETURN, Callback(this, &CUICustomEdit::press_commit));
	ec().assign_callback(SDL_SCANCODE_KP_ENTER, Callback(this, &CUICustomEdit::press_commit));
	ec().assign_callback(SDL_SCANCODE_GRAVE, Callback(this, &CUICustomEdit::nothing));
	ec().assign_callback(SDL_SCANCODE_GRAVE, Callback(this, &CUICustomEdit::press_tab));
}
