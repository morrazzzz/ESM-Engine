...
public:
	...
	CUIStatic		UIDialogStatic;
	CUIStatic		UIOurPhrasesStatic;
	...
	void				AddIconedAnswer		(LPCSTR text, LPCSTR texture_name, LPCSTR templ_name);
	void				ClearAll			();
	void				ClearQuestions		();
...
public:
	...
	void			Init					(LPCSTR text, LPCSTR texture_name);
