...
CSE_Abstract* xrServer::Process_spawn(NET_Packet& P, ClientID sender, CSE_Abstract* tpExistedEntity)
{
...
//			VERIFY3			(smart_cast<CSE_ALifeItemBolt*>(E) || smart_cast<CSE_ALifeItemGrenade*>(E),*E->s_name,E->name_replace());
	...
	{
		CL->owner		= E;
		E->set_name_replace(CL->name.c_str());
	}
