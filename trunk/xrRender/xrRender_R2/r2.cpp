...
void CRender::fillShadersStaticMacro()
{
	...
	renderShadersMacro.fillShaderMacroBool("USE_HWSMAP", o.HW_smap);
	renderShadersMacro.fillShaderMacroBool("USE_HWSMAP_PCF", o.HW_smap_PCF);
	renderShadersMacro.fillShaderMacroBool("USE_FETCH4", o.HW_smap_FETCH4);
	...
	renderShadersMacro.fillShaderMacroBool("FORCE_GLOSS", o.forcegloss_v, c_gloss);
	...
	renderShadersMacro.fillShaderMacroBool("SSAO_OPT_DATA", o.ssao_opt_data ? (o.ssao_half_data ? 2 : 1) : 0, o.ssao_half_data ? "2" : "1");
